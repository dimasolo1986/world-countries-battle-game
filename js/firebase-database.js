...
const o = !1,
  ...
  assertionError = function (e) {
    return new Error(
      "Firebase Database (" + s + ") INTERNAL ASSERT FAILED: " + e
    );
  },
...
const getDefaultsFromGlobal = () =>
  ...
  getDefaultEmulatorHostnameAndPort = (e) => {
    const t = ((e) => getDefaults()?.emulatorHosts?.[e])(e);
    if (!t) return;
...
function updateEmulatorBanner(e, t) {
    ...
    r =
      (function getEmulatorSummary() {
        ...
        for (const t of Object.keys(l))
          l[t] ? e.emulator.push(t) : e.prod.push(t);
        return e;
      })().prod.length > 0;
  ...
  function setupDom() {
    const e = (function getOrCreateEl(e) {
      ...
      o = prefixedId("learnmore"),
      s = document.getElementById(o) || document.createElement("a"),
...
const createStoragefor = function (e) {
  ...
  g = createStoragefor("localStorage"),
  C = createStoragefor("sessionStorage"),
  v = new (class Logger {
    constructor(e) {
      (this.name = e),
        (this._logLevel = p),
...
const enableLogging$1 = function (e, t) {
    assert(
      ...
      !0 === e
        ? ((v.logLevel = d.VERBOSE),
          (T = v.log.bind(v)),
          t && C.set("logging_enabled", !0))
        : "function" == typeof e
        ? (T = e)
        : ((T = null), C.remove("logging_enabled"));
  },
  log = function (...e) {
    if (
      (!0 === E &&
        ((E = !1),
        null === T && !0 === C.get("logging_enabled") && enableLogging$1(!0)),
      T)
    ) {
...
const b =
  ...
  R = "long_polling";
class RepoInfo {
  constructor(e, t, n, r, i = !1, o = "", s = !1, a = !1, l = null) {
    (this.secure = t),
      (this.namespace = n),
      ...
      (this.internalHost = g.get("host:" + e) || this._host);
  }
  isCacheableHost() {
  ...
  set host(e) {
    e !== this.internalHost &&
      ((this.internalHost = e),
      this.isCacheableHost() && g.set("host:" + this._host, this.internalHost));
  }
  toString() {
...
function repoInfoConnectionURL(e, t, n) {
  ...
  if (
    ...
    if (t !== R) throw new Error("Unknown connection type: " + t);
...
function statsManagerGetCollection(e) {
  const t = e.toString();
  return A[t] || (A[t] = new StatsCollection()), A[t];
}
...
class BrowserPollConnection {
  constructor(e, t, n, r, i, o, s) {
    (this.connId = e),
      ...
      (this.urlFn = (e) => (
        this.appCheckToken && (e[N] = this.appCheckToken),
        repoInfoConnectionURL(t, R, e)
      ));
  }
  open(e, t) {
...
class FirebaseIFrameScriptHolder {
  constructor(e, t, n, r) {
    (this.onDisconnect = n),
      ...
      (this.sendNewPolls = !0);
    {
      (this.uniqueCallbackIdentifier = w()),
...
class WebSocketConnection {
  ...
  open(e, t) {
    (this.onDisconnect = t),
      ...
      (this.everConnected_ = !1),
      g.set("previous_websocket_failure", !0);
    try {
      let e;
      isNodeSdk(), (this.mySock = new O(this.connURL, [], e));
    } catch (e) {
  ...
  static previouslyFailed() {
    return g.isInMemoryStorage || !0 === g.get("previous_websocket_failure");
  }
  markConnectionHealthy() {
    g.remove("previous_websocket_failure");
  }
  appendFrame_(e) {
      ...
      e || 0 !== this.state_
        ...
        : (this.log_("Realtime connection failed."),
          this.repoInfo_.isCacheableHost() &&
            (g.remove("host:" + this.repoInfo_.host),
...
const priorityHashText = function (e) {
  ...
  validatePriorityNode = function (e) {
    ...
    } else assert(e === W || e.isEmpty(), "priority of unexpected type.");
    assert(
...
const B = new (class PriorityIndex extends Index {
    compare(e, t) {
    ...
    maxPost() {
      return new NamedNode(P, new LeafNode("[PRIORITY-POST]", Q));
    }
    makePost(e, t) {
      const n = G(e);
...
class Base12Num {
  constructor(e) {
    var t;
    (this.count = ((t = e + 1), parseInt(Math.log(t) / V, 10))),
...
class IndexMap {
  static get Default() {
    return (
      assert(H && B, "ChildrenNode.ts has not been loaded"),
      (U = U || new IndexMap({ ".priority": H }, { ".priority": B })),
      U
    );
  }
  constructor(e, t) {
  ...
  addIndex(e, t) {
    ...
    o = r ? buildChildSet(n, e.getCompare()) : H;
    const a = e.toString(),
      l = { ...this.indexSet_ };
    l[a] = e;
  ...
  addToIndexes(e, t) {
    const n = map(this.indexes_, (n, r) => {
      ...
      if ((assert(i, "Missing index implementation for " + r), n === H)) {
...
class ChildrenNode {
  ...
  updateImmediateChild(e, t) {
      ...
      return this.updatePriority(t);
    {
      ...
      const o = r.isEmpty() ? j : this.priorityNode_;
  ...
  withIndex(e) {
    if (e === M || this.indexMap_.hasIndex(e)) return this;
    {
  ...
  isIndexed(e) {
    return e === M || this.indexMap_.hasIndex(e);
  }
  equals(e) {
    if (e === this) return !0;
  ...
  resolveIndex_(e) {
    return e === M ? null : this.indexMap_.get(e.toString());
  }
}
ChildrenNode.INTEGER_REGEXP_ = /^(0|[1-9]\d*)$/;
const z = new (class MaxNode extends ChildrenNode {
  constructor() {
    super(
      new SortedMap(NAME_COMPARATOR),
...
Object.defineProperties(NamedNode, {
  MIN: { value: new NamedNode(S, ChildrenNode.EMPTY_NODE) },
  MAX: { value: new NamedNode(P, z) },
}),
...
function nodeFromJSON(e, t = null) {
  ...
  }
  {
    ...
    if (r) {
      const e = buildChildSet(n, B.getCompare());
      return new ChildrenNode(
        i,
        nodeFromJSON(t),
        new IndexMap({ ".priority": e }, { ".priority": B })
      );
    }
...
class PathIndex extends Index {
  ...
  maxPost() {
    const e = ChildrenNode.EMPTY_NODE.updateChild(this.indexPath_, z);
    return new NamedNode(P, e);
  }
  toString() {
    return pathSlice(this.indexPath_, 0).join("/");
  }
}
const K = new (class ValueIndex extends Index {
  compare(e, t) {
...
class QueryParams {
  ...
  getIndexStartName() {
    return (
      assert(this.startSet_, "Only valid if start has been set"),
      this.startNameSet_ ? this.indexStartName_ : S
    );
  }
  hasEnd() {
    return this.endSet_;
  ...
  isDefault() {
    return this.loadsAllData() && this.index_ === B;
  }
  copy() {
...
class ImmutableTree {
  ...
  constructor(e, t = (() => ($ || ($ = new SortedMap(stringCompare)), $))()) {
...
const J = new (class NoCompleteChildSource_ {
  getCompleteChild(e) {
    return null;
  }
...
function viewProcessorApplyOperation(e, t, n, r, i) {
  ...
  if (n.type === Y.OVERWRITE) {
    ...
    s = (function viewProcessorListenComplete(e, t, n, r, i) {
      ...
      return viewProcessorGenerateEventCacheAfterServerEvent(e, s, n, r, J, i);
    })(e, t, n.path, r, o);
  }
  ...
  if (pathIsEmpty(n)) h = c.updateFullNode(l.getNode(), r, null);
    ...
    h =
      ".priority" === e
        ...
        : c.updateChild(l.getNode(), e, o, i, J, null);
  }
    ...
    a &&
      ...
      o.push(
        new ((function syncPointGetReferenceConstructor() {
          return assert(Z, "Reference.ts has not been loaded"), Z;
        })())(t._repo, t._path)
      ),
    { removed: o, events: s }
  );
...
function syncTreeQueryForListening_(e) {
  return e._queryParams.loadsAllData() && !e._queryParams.isDefault()
    ? new ((function syncTreeGetReferenceConstructor() {
        return assert(X, "Reference.ts has not been loaded"), X;
      })())(e._repo, e._path)
    : e;
}
...
const te = /[\[\].#$\/\u0000-\u001F\u007F]/,
  ...
  isValidPathString = function (e) {
    return "string" == typeof e && 0 !== e.length && !ne.test(e);
  },
  ...
  validateFirebaseData = function (e, t, n) {
    ...
    if ("string" == typeof t && t.length > re / 3 && stringLength(t) > re)
      throw new Error(
        e +
...
function eventListRaise(e) {
  for (let t = 0; t < e.events.length; t++) {
    ...
    if (null !== n) {
      ...
      T && log("event: " + n.toString()), exceptionGuard(r);
    }
  }
}
const ie = "repo_interrupt";
class Repo {
  constructor(e, t, n, r) {
    (this.repoInfo_ = e),
...
function repoInterrupt(e) {
  e.persistentConnection_ && e.persistentConnection_.interrupt(ie);
}
      ...
      for (let o = 0; o < t.length; o++) {
        ...
        if (
          ...
          if (l.retryCount >= 25)
            ...
            const n = repoGetLatestState(e, l.path, s);
            ...
            if (void 0 !== r) {
              ...
              (l.currentOutputSnapshotRaw = t),
                ...
                (i = i.concat(syncTreeAckUserWrite(e.serverSyncTree_, o, !0)));
            } else
              (d = !0),
                (c = "nodata"),
                (i = i.concat(
          ...
          d &&
            ...
            t[o].onComplete &&
              ("nodata" === c
                ...
                : r.push(() => t[o].onComplete(new Error(c), !1, null))));
      }
      var a;
...
const parseRepoInfo = function (e, t) {
  ...
  oe = "-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",
  se = (function () {
    let e = 0;
    const t = [];
    return function (n) {
      ...
      const o = new Array(8);
      for (i = 7; i >= 0; i--)
        (o[i] = oe.charAt(n % 64)), (n = Math.floor(n / 64));
      ...
      for (i = 0; i < 12; i++) s += oe.charAt(t[i]);
...
function validateQueryEndpoints(e) {
  ...
  if (
    ...
    if (e.hasStart()) {
      if (e.getIndexStartName() !== S) throw new Error(r);
    ...
    (assert(
      e.getIndex() instanceof PathIndex || e.getIndex() === K,
      "unknown index type."
    ),
...
class DataSnapshot {
  ...
  child(e) {
    const t = new Path(e),
      n = child(this.ref, e);
    return new DataSnapshot(this._node.getChild(t), n, B);
  }
  exists() {
  ...
  forEach(e) {
    ...
    return !!this._node.forEachChild(this._index, (t, n) =>
      e(new DataSnapshot(n, child(this.ref, t), B))
    );
  }
  hasChild(e) {
    const t = new Path(e);
...
class QueryOrderByKeyConstraint extends QueryConstraint {
  ...
  _apply(e) {
    ...
    const t = queryParamsOrderBy(e._queryParams, M);
...
class QueryOrderByValueConstraint extends QueryConstraint {
  ...
  _apply(e) {
    ...
    const t = queryParamsOrderBy(e._queryParams, K);
    return validateQueryEndpoints(t), new QueryImpl(e._repo, e._path, t, !0);
  }
}
...
!(function syncPointSetReferenceConstructor(e) {
  assert(!Z, "__referenceConstructor has already been defined"), (Z = e);
})(ReferenceImpl),
  (function syncTreeSetReferenceConstructor(e) {
    assert(!X, "__referenceConstructor has already been defined"), (X = e);
  })(ReferenceImpl);
const ae = {};
let le = !1;
function repoManagerDatabaseFromApp(e, t, n, r, i) {
  ...
  const d = (function repoManagerCreateRepo(e, t, n, r) {
    ...
    return (o = new Repo(e, le, n, r)), (i[e.toURLString()] = o), o;
  })(h, e, c, new AppCheckTokenProvider(e, n));
...
function connectDatabaseEmulator(e, t, n, r = {}) {
  ...
  if (e._instanceStarted) {
    if (
      ...
      deepEqual(r, o.repoInfo_.emulatorOptions)
    )
      return;
    fatal(
  ...
  if (o.repoInfo_.nodeAdmin)
    r.mockUserToken &&
      ...
      (s = new EmulatorTokenProvider(EmulatorTokenProvider.OWNER));
...
function goOnline(e) {
  (e = getModularInstance(e))._checkNotDeleted("goOnline"),
    (function repoResume(e) {
      e.persistentConnection_ && e.persistentConnection_.resume(ie);
    })(e._repo);
}
function enableLogging(e, t) {
  enableLogging$1(e, t);
}
const he = { ".sv": "timestamp" };
  ...
  return (
    (function repoStartTransaction(e, t, n, r, i, o) {
      ...
      (t, n, r) => {
        ...
        t
          ? i.reject(t)
          : ((o = new DataSnapshot(r, new ReferenceImpl(e._repo, e._path), B)),
            i.resolve(new TransactionResult(n, o)));
      },
      o,
      r
    ),
