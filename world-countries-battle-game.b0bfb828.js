 ...
 */ !function(t, e) {
    ...
    var mt = {
        ...
        flyTo: function(n, o, t) {
            ...
            var g = Date.now(), v = (d(1) - m) / u, y = t.duration ? 1e3 * t.duration : 1e3 * v * 0.8;
    ...
    var vt = {
        ...
        unproject: function(t) {
            for(var e, i = 180 / Math.PI, n = this.R, o = this.R_MINOR / n, s = Math.sqrt(1 - o * o), r = Math.exp(-t.y / n), a = Math.PI / 2 - 2 * Math.atan(r), h = 0, l = 0.1; h < 15 && 1e-7 < Math.abs(l); h++)e = s * Math.sin(a), e = Math.pow((1 - e) / (1 + e), s / 2), a += l = Math.PI / 2 - 2 * Math.atan(r * e) - a;
    ...
    var Ai = o.extend({
        ...
        _addFocusListenersOnLayer: function(t) {
            ...
            e && (S(e, "focus", function() {
                if (this._tooltip) this._tooltip._source = t, this.openTooltip();
    ...
    var Wi = o.extend({
        ...
        _updateTransform: function(t, e) {
            var i = this._map.getZoomScale(e, this._zoom), n = this._map.getSize().multiplyBy(0.5 + this.options.padding), o = this._map.project(this._center, e), n = n.multiplyBy(-i).add(o).subtract(this._map._getNewPixelOrigin(t, e));
...
//# sourceMappingURL=world-countries-battle-game.b0bfb828.js.map
